...
resource "oci_core_instance" "firewall-1" {
    ...
    extended_metadata = {
        # Firewall #1 IPs
        "firewall-int-ip" = "${var.firewall-1_int_ip}"
        "firewall-int-ipv6" = "${var.firewall-1_int_ipv6}"
        "firewall-ext-ip" = "${var.firewall-1_ext_ip}"
        "firewall-ext-ipv6" = "${var.firewall-1_ext_ipv6}"
    ...
    create_vnic_details {
        ...
        private_ip = "${var.firewall-1_int_ip}"        
        ...
        ipv6address_ipv6subnet_cidr_pair_details {
           ...
           ipv6address = "${var.firewall-1_int_ipv6}"
        }
    }
}

# VNIC vcn-fw-ext
resource "oci_core_vnic_attachment" "firewall-1_vnic-ext" {  
    ...
    create_vnic_details {    
        ...
        private_ip = "${var.firewall-1_ext_ip}"   
        ...
        ipv6address_ipv6subnet_cidr_pair_details {
           ...
           ipv6_address = "${var.firewall-1_ext_ipv6}"
        }
    }       
